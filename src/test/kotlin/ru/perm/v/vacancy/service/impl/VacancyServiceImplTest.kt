...
class VacancyServiceImplTest {
    ...
    fun getAll()  {
        ...
        val companyEntity_200 = CompanyEntity(N_COMPANY_200, NAME_COMPANY_200);
        val vacancyEntity200 = VacancyEntity(N_200, NAME_VACANCY_200, COMMENT_200, companyEntity_200);
        ...
        assertEquals(VacancyDto(N_100, NAME_VACANCY_100, COMMENT_100, CompanyDto(N_COMPANY_100, NAME_COMPANY_100)), vacancyDtos.get(0));
    }
}